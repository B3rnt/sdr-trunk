...
public class CapacityMaxTalkerAliasContinuation extends CapacityPlusVoiceChannelUser
{
    ...
    /**
     * Raw alias payload bits carried by this continuation message.  Note: this fragment must be combined with the
     * header message's alias fragment and decoded as a single value -- decoding this fragment in isolation can
